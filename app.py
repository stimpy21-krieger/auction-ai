...
<style>
    ...
    /* 🌟 파일 업로드 창 초강력 CSS 해킹 (영어 완벽 제거 및 한글 삽입) 🌟 */
    ...
    /* 최상단에 예쁜 한글 안내문 띄우기 */
    [data-testid="stFileUploadDropzone"] > div > div:first-child::before {
        content: '📸 터치해서 등기부등본 사진 올리기' !important;
